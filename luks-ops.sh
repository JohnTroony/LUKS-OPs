...
# Variables
constant="luks_"
cryptdev=$(cat /dev/urandom | tr -dc 'a-z'| head -c 8)
...
case $full_spec in
	...
	;;
	*) echo -e $red"Bad option! I'm getting a tattoo of your name! \n"$none
	exit 1;
	;;
esac
...
case "$1" in 
	...
	usage
	;;
	*) echo -e $red"Oooops! I didn't get what you did there.. "$none # (usage func) Print help message and exit
	usage
	;;
esac
